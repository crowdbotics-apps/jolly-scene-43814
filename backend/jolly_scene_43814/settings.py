"""
Django settings for jolly_scene_43814 project.
...
ROOT_URLCONF = 'jolly_scene_43814.urls'
...
WSGI_APPLICATION = 'jolly_scene_43814.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jolly_scene_43814 API",
    "DESCRIPTION": "API documentation for jolly_scene_43814 App",
    "VERSION": "v1",
}
